...
let rec mastermind2 nom1 nom2 tentatives parties =
 let crlscr = Sys.command("clear") in
  let participants = creationjoueurs2 nom1 nom2 in
    let couplejoueurs = commence participants in let partie_pairs = nb_parties_pairs parties in let winner = run_parties_pvp partie_pairs couplejoueurs tentatives in gagnant winner;;
